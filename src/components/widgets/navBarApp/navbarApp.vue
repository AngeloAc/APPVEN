   ...
   <div class="shadown-lg"
    ...
    <div style="display: block; align-items: center; max-height: 500px; ">
      <div style="margin-bottom: 17px;">
        <p style="font-size: 8px; color: white;">whatsaspp</p>
      </div>

      <div style="padding: 10px;">
        <ul style="list-style: none; padding: 0px; margin: 0px;">
          <li style="margin-bottom: 15px;">
            <router-link to="/whatsapphome" style="color: white;">
          ...
          <li style="margin-bottom: 15px;">
          <router-link to="/hosts" style="color: white;">
          ...
          <li style="margin-bottom: 15px;">
            <router-link to="/whatsappbot" style="color: white;">
          ...
          <li style="margin-bottom: 15px;">
            <router-link to="/whatsappchat" style="color: white;">
          ...
          <li style="margin-bottom: 15px;">
            <router-link to="/whatsappsettings" style="color: white;">
