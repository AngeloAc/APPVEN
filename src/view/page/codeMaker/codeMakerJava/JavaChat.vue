        ...
        <div class="side-chat shadow-lg">
            ...
            <div v-if="loading" class="loading-container">
                ...
                <div class="conversation" v-for="(javaChat, index) in javaChat" :key="index" @click="selectChat(index)">
                    ...
                    <svg v-if="javaChat.code === 'python'" class="avatar" xmlns="http://www.w3.org/2000/svg" height="1em"
                    ...
                    <svg v-if="javaChat.code === 'html'" class="avatar" xmlns="http://www.w3.org/2000/svg" height="0.625em"
                        viewBox="0 0 384 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <path
                    ...
                    <div class="info">
                        ...
                        <p v-if="javaChat.code === 'c'"
                            style="background-color: rgba(255, 0, 0, 0.2); padding: 2px; font-size: 8px; border: none; border-radius: 5px; text-align: center; width: 42px;">
                            {{ javaChat.code }}</p>
