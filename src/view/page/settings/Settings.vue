          ...
          <div class="container p-4">
            ...
            <div class="user-info">
              ...
              <form action="" @submit.prevent="onSubmitForm">
                <div class="user-details">
                  ...
                  <div class="user-info-row">
                    ...
                    <div class="password-input">
                      <input id="password" class="user-info-input" :type="showPassword ? 'text' : 'password'" v-model="newPassword" placeholder="Nova senha">
                ...
                <button class="btn edit-profile-btn" @click="editProfile"><i class="bi bi-pencil"></i> Editar o seu perfil</button>
              </form>
            </div>
...
@media (max-width: 768px) {
  ...
  .main-content {
    margin-top: 40px;
    margin-left: 0;
    padding: 10px; /* Adicionado espaço interno menor */
  }
  .user-info-label {
    display: none;
    }
  .user-info-input {
    width: 100%; /* Alterado para ocupar todo o espaço disponível */
  }
}
</style>